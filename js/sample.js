(function() {
    ...
    var r = "closure_uid_" + (1E9 * Math.random() >>> 0), ba = 0;
    function ca(a, b, c) {
    ...
    ;
    var x = Array.prototype, fa = x.indexOf ? function(a, b, c) {
    ...
    ;
    var ma = -1 != B.indexOf("Opera") || -1 != B.indexOf("OPR"), D = -1 != B.indexOf("Edge") || -1 != B.indexOf("Trident") || -1 != B.indexOf("MSIE"), E = -1 != B.indexOf("Gecko") && !(-1 != B.toLowerCase().indexOf("webkit") && !C()) && !(-1 != B.indexOf("Trident") || -1 != B.indexOf("MSIE")) && !C(), na = -1 != B.toLowerCase().indexOf("webkit") && !C();
    function oa() {
        var a = B;
        if (E)
            return /rv\:([^\);]+)(\)|;)/.exec(a);
    ...
    function sa(a) {
        if (!ra[a]) {
            for (var b = 0, c = ea(String(qa)).split("."), d = ea(String(a)).split("."), e = Math.max(c.length, d.length), g = 0; 0 == b && g < e; g++) {
                var k = c[g] || "", l = d[g] || "", ab = RegExp("(\\d*)(\\D*)", "g"), bb = RegExp("(\\d*)(\\D*)", "g");
                do {
                    var K = ab.exec(k) || ["", "", ""], L = bb.exec(l) || ["", "", ""];
    ...
    var ta = h.document, ua = pa(), va = !ta || !D || !ua && C() ? void 0 : ua || ("CSS1Compat" == ta.compatMode ? parseInt(qa, 10) : 5);
    var F;
    if (!(F = !E && !D)) {
        var G;
        if (G = D)
        ...
        if (null == b)
            ...
            if ("object" == typeof b) {
                ...
                if (b instanceof String || b instanceof Number || b instanceof Boolean)
                    ...
                    e = "";
                    for (d in b)
                        Object.prototype.hasOwnProperty.call(b, d) && (g = b[d], "function" != typeof g && (c.push(e), Ba(d, c), c.push(":"), Aa(a, g, c), e = ","));
                    c.push("}");
                    return
                }
            }
    ...
    f.clear = function(a) {
        if (a) {
            var b = this.d[a];
            b && (y(b, this.F, this), delete this.d[a])
        } else
            this.c.length = 0, this.d = {}
    };
    f.A = function() {
        I.D.A.call(this);
        this.clear();
    ...
    function Ga(a) {
        if (Ha) {
            ...
            if (b) {
                var c = b.href;
                if (c && (c = (c = Ga(c)[3] || null) ? decodeURI(c) : c) && c != b.hostname)
                    throw Ha = !0, Error();
            }
        }
        return a.match(Fa)
    ...
    f.wheelDeltaX = 0;
    f.wheelDeltaY = 0;
    var Ra = {stopImmediatePropagation: 1,stopPropagation: 1,preventMouseEvent: 1,preventManipulation: 1,preventDefault: 1,layerX: 1,layerY: 1,scale: 1,rotation: 1};
    var A = m("yt.events.listeners_") || {};
    u("yt.events.listeners_", A);
    var Sa = m("yt.events.counter_") || {count: 0};
    ...
    function Va(a) {
        a && ("string" == typeof a && (a = [a]), y(a, function(a) {
            if (a in A) {
                var c = A[a], d = c[0], e = c[1], g = c[3], c = c[4];
    ...
    function P(a, b, c) {
        ...
        if (a = q(a) ? b.getElementById(a) : a)
            if ("iframe" != a.tagName.toLowerCase() && (b = fb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.c = a, this.c.id || (b = a = this.c, b = b[r] || (b[r] = ++ba), a.id = "widget" + b), N[this.c.id] = this, window.postMessage) {
                this.f = new I;
                gb(this);
                a = Q(this.d, "events");
                for (var d in a)
    ...
    f.P = function() {
        ...
        if (this.h) {
            ...
            (a = this.c) && a.parentNode && a.parentNode.removeChild(a);
        R && (R[this.j] = null);
        this.d = null;
        var a = this.c, c;
        for (c in A)
    ...
    function fb(a, b) {
        ...
        c.setAttribute("title", "YouTube " + Q(a.d, "title"));
        (d = Q(a.d, "width")) && c.setAttribute("width", d);
        (d = Q(a.d, "height")) && c.setAttribute("height", d);
        var l = a.r();
        ...
        window.location.href && y(["debugjs", "debugcss"], function(a) {
            ...
            b: {
                ...
                for (var e = a.length; 0 <= (d = b.indexOf(a, d)) && d < c; ) {
                    ...
                    if (38 == g || 63 == g)
                        if (g = b.charCodeAt(d + e), !g || 61 == g || 38 == g || 35 == g)
                            break b;
                    d += e + 1
                }
                d = -1
        ...
        c.src = Q(a.d, "host") + a.v() + "?" + Wa(l);
        return c
    }
    f.H = function() {
        this.c && this.c.contentWindow ? this.C({event: "listening"}) : window.clearInterval(this.e)
    };
    function gb(a) {
        jb(a.d, a, a.j);
        a.e = Na(t(a.H, a));
        Ua(a.c, "load", t(function() {
            ...
            this.e = Na(t(this.H, this))
        }, a))
    }
    function ib(a, b) {
        a.G[b] || (a.G[b] = !0, S(a, "addEventListener", [b]))
    }
    f.C = function(a) {
        a.id = this.j;
        var b = [];
        Aa(new za, a, b);
        a = b.join("");
        var b = this.d, c, d = Ga(this.c.src);
        c = d[1];
        var e = d[2], g = d[3], d = d[4], k = "";
        c && (k += c + ":");
        g && (k += "//", e && (k += e + "@"), k += g, d && (k += ":" + d));
        c = k;
    ...
    var T = "StopIteration" in h ? h.StopIteration : Error("StopIteration");
    function U() {
    }
    ...
    function W(a) {
        ...
        if (this.c = !!("https:" == document.location.protocol || a && 0 == a.src.indexOf("https:"))) {
            a = [this.d, window.YTConfig || {}, this.defaults];
    ...
    var R = null;
    function Q(a, b) {
        for (var c = [a.d, window.YTConfig || {}, a.defaults], d = 0; d < c.length; d++) {
            var e = c[d][b];
            if (void 0 != e)
                return e
        }
    ...
    W.prototype.f = function(a) {
        ...
        if (b) {
            ...
            if (a = R[c.id])
                a.B = !0, a.B && (y(a.t, a.C, a), a.t.length = 0), a.J(c)
        }
    };
    function vb(a) {
        W.call(this, a);
    ...
    f = X.prototype;
    f.v = function() {
        return "/embed/" + Q(this.d, "videoId")
    };
    f.r = function() {
        var a;
        if (Q(this.d, "playerVars")) {
            a = Q(this.d, "playerVars");
            var b = {}, c;
            for (c in a)
                b[c] = a[c];
            a = b
    ...
    function yb(a, b) {
        y(b, function(a) {
            this[a] || (rb(a) ? this[a] = function() {
                ...
                return this.n[a.charAt(b).toLowerCase() + a.substr(b + 1)]
            } : this[a] = function() {
                S(this, a, arguments);
                return this
            })
    ...
    f.U = function() {
        var a = this.c.cloneNode(!1), b = this.n.videoData, c = Q(this.d, "host");
    ...
    f.T = function(a) {
        return this.k.namespaces ? a ? this.k[a].options || [] : this.k.namespaces || [] : []
    };
    f.S = function(a, b) {
        if (this.k.namespaces && a && b)
            return this.k[a][b]
    };
    function zb(a) {
        W.call(this, a);
    ...
    Y.prototype.r = function() {
        return {player: 0,thumb_width: Q(this.d, "thumbWidth"),thumb_height: Q(this.d, "thumbHeight"),thumb_align: Q(this.d, "thumbAlign")}
    };
    ...
    u("YT.Thumbnail", Y);
    u("YT.UploadWidget", Z);
    P.prototype.destroy = P.prototype.P;
    P.prototype.setSize = P.prototype.R;
    P.prototype.getIframe = P.prototype.Q;
